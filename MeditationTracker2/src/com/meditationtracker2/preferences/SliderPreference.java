...
public class SliderPreference extends Preference {
	...
	public SliderPreference(Context context, AttributeSet attrs) {
		...
		TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.Attributes);
		max = array.getInteger(R.styleable.Attributes_max, 100);
		actorClass = array.getString(R.styleable.Attributes_actor);
